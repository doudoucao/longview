...
Status: initial synthesis from the first saved Firecrawl source batch.

Access date: 2026-06-19

This is not the final research report. It extracts early patterns from the saved raw materials in `sources/raw/` and the source index in `sources/index.md`.
...
See `sources/index.md` for raw file paths and source metadata.
